...
<center>Kube-proxy iptables模式（来自[Kubernetes官网文档](https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies/)<sup>[[1]](#ref01)</sup>)</center>
...
<center>Kube-proxy ipvs模式（来自[Kubernetes官网文档](https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies/)<sup>[[1]](#ref01)</sup>)</center>
...
<center>采用Ingress, NodePortal和LoadBalancer提供外部流量入口的拓扑结构</center>
...
<center>采用Ingress, NodePortal和LoadBalancer提供外部流量入口的实现原理</center>
